...
<main>
    <div class="contenthelp">
        ...
        <h3>"Precisa de ajuda? Você está no lugar certo! Aqui você encontra todas as informações que precisa para navegar pelo sistema."</h3><br>
        <h2>Navegue pelo sistema com facilidade:</h2><br>
        ...
        <h3>Para cadastrar um novo doador</h3>
        <ul>
        ...
        <h3>Visualizando Cadastros de Doadores</h3>
        <ul>
        ...
        <h3>Visualizar Informações Principais</h3>
        <ul>
        ...
        <h3>Mensagem de Erros e Problemas</h3>
        <ul>
